...
struct Constants {
    ...
    static let DISCORD_AUTH_URL = {
        #if DEBUG
        return "https://discord.com/api/oauth2/authorize?client_id=620286491498774529&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Flogin%2Fcallback&scope=identify+email"
        #else
